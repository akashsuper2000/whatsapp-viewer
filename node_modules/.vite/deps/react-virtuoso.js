...
function systemToComponent(systemSpec, map2, Root) {
  ...
  const Component = import_react.default.forwardRef((propsWithChildren, ref) => {
    ...
    return import_react.default.createElement(
      Context.Provider,
      { value: system2 },
      Root ? import_react.default.createElement(
        Root,
...
var combinedSystem$2 = system(([listSystem2, propsSystem]) => {
  return { ...listSystem2, ...propsSystem };
}, tup(listSystem, listComponentPropsSystem));
var DefaultScrollSeekPlaceholder$1 = ({ height }) => import_react.default.createElement("div", { style: { height } });
var GROUP_STYLE = { position: positionStickyCssValue(), zIndex: 1, overflowAnchor: "none" };
var ITEM_STYLE$1 = { overflowAnchor: "none" };
var Items$1 = import_react.default.memo(function VirtuosoItems({ showTopList = false }) {
  ...
  return import_react.default.createElement(
    ...
    (showTopList ? listState.topItems : listState.items).map((item) => {
      ...
      if (isSeeking) {
        return import_react.default.createElement(ScrollSeekPlaceholder, {
...
var Header$1 = import_react.default.memo(function VirtuosoHeader() {
...
var Footer$1 = import_react.default.memo(function VirtuosoFooter() {
...
function buildScroller({ usePublisher: usePublisher2, useEmitter: useEmitter2, useEmitterValue: useEmitterValue2 }) {
  const Scroller2 = import_react.default.memo(function VirtuosoScroller({ style, children, ...props }) {
...
function buildWindowScroller({ usePublisher: usePublisher2, useEmitter: useEmitter2, useEmitterValue: useEmitterValue2 }) {
  const Scroller2 = import_react.default.memo(function VirtuosoWindowScroller({ style, children, ...props }) {
...
var Viewport$2 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { style: viewportStyle, ref: viewportRef, "data-viewport-type": "element" }, children);
};
var WindowViewport$2 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { ref: viewportRef, style: viewportStyle, "data-viewport-type": "window" }, children);
};
...
var ListRoot = import_react.default.memo(function VirtuosoRoot(props) {
  const useWindowScroll = useEmitterValue$2("useWindowScroll");
  ...
  return import_react.default.createElement(TheScroller, { ...props }, showTopList && import_react.default.createElement(TopItemListContainer, null, import_react.default.createElement(Items$1, { showTopList: true })), import_react.default.createElement(TheViewport, null, import_react.default.createElement(Header$1, null), import_react.default.createElement(Items$1, null), import_react.default.createElement(Footer$1, null)));
});
var {
  Component: List,
...
var Scroller$2 = buildScroller({ usePublisher: usePublisher$2, useEmitterValue: useEmitterValue$2, useEmitter: useEmitter$2 });
var WindowScroller$2 = buildWindowScroller({ usePublisher: usePublisher$2, useEmitterValue: useEmitterValue$2, useEmitter: useEmitter$2 });
var Virtuoso = List;
...
var combinedSystem$1 = system(([gridSystem2, gridComponentPropsSystem2]) => {
  return { ...gridSystem2, ...gridComponentPropsSystem2 };
}, tup(gridSystem, gridComponentPropsSystem));
var GridItems = import_react.default.memo(function GridItems2() {
  ...
  return import_react.default.createElement(
    ...
    gridState.items.map((item) => {
      ...
      return isSeeking ? import_react.default.createElement(ScrollSeekPlaceholder, {
        key,
        ...contextPropIfNotDomElement(ScrollSeekPlaceholder, context),
        index: item.index,
...
var Viewport$1 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { style: viewportStyle, ref: viewportRef }, children);
};
var WindowViewport$1 = ({ children }) => {
  ...
  return import_react.default.createElement("div", { ref: viewportRef, style: viewportStyle }, children);
};
var GridRoot = import_react.default.memo(function GridRoot2({ ...props }) {
  ...
  return import_react.default.createElement(TheScroller, { ...props }, import_react.default.createElement(TheViewport, null, import_react.default.createElement(Header, null), import_react.default.createElement(GridItems, null), import_react.default.createElement(Footer, null)));
});
var {
  Component: Grid,
...
var Scroller$1 = buildScroller({ usePublisher: usePublisher$1, useEmitterValue: useEmitterValue$1, useEmitter: useEmitter$1 });
var WindowScroller$1 = buildWindowScroller({ usePublisher: usePublisher$1, useEmitterValue: useEmitterValue$1, useEmitter: useEmitter$1 });
...
var tableComponentPropsSystem = system(() => {
  const itemContent = statefulStream((index) => import_react.default.createElement("td", null, "Item $", index));
  const context = statefulStream(null);
...
var DefaultScrollSeekPlaceholder = ({ height }) => import_react.default.createElement("tr", null, import_react.default.createElement("td", { style: { height } }));
var DefaultFillerRow = ({ height }) => import_react.default.createElement("tr", null, import_react.default.createElement("td", { style: { height, padding: 0, border: 0 } }));
var ITEM_STYLE = { overflowAnchor: "none" };
var Items = import_react.default.memo(function VirtuosoItems2() {
  ...
  const paddingTopEl = paddingTop > 0 ? import_react.default.createElement(FillerRow, { height: paddingTop, key: "padding-top", context }) : null;
  const paddingBottomEl = paddingBottom > 0 ? import_react.default.createElement(FillerRow, { height: paddingBottom, key: "padding-bottom", context }) : null;
...
var TableRoot = import_react.default.memo(function TableVirtuosoRoot(props) {
  const useWindowScroll = useEmitterValue("useWindowScroll");
  const customScrollParent = useEmitterValue("customScrollParent");
  ...
  return import_react.default.createElement(TheScroller, { ...props }, import_react.default.createElement(TheViewport, null, import_react.default.createElement(
    TheTable,
    { style: { borderSpacing: 0, overflowAnchor: "none" }, ...contextPropIfNotDomElement(TheTable, context) },
    [theHead, import_react.default.createElement(Items, { key: "TableBody" }), theFoot]
  )));
});
var {
  Component: Table,
...
var WindowScroller = buildWindowScroller({ usePublisher, useEmitterValue, useEmitter });
